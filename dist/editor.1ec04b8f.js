...
var _levelCodeToRawLevel = require("../level_code_to_raw_level");
const palette = (0, _paletteJsonDefault.default);
let allLevels = null;
function App() {
    const [editingIndex, setEditingIndex] = (0, _react.useState)(0);
    const [selected, setSelected] = (0, _react.useState)("W");
    const [applying, setApplying] = (0, _react.useState)("");
    const [levels, setLevels] = (0, _react.useState)([]);
    (0, _react.useEffect)(()=>{
        fetch("http://localhost:4400/src/data/levels.json").then((r)=>r.json()).then((lvls)=>{
            const cleaned = lvls.map((l)=>({
                    name: l.name.trim(),
                    size: l.size,
                    bricks: (l.bricks + "_".repeat(l.size * l.size)).slice(0, l.size * l.size),
    ...
    const updateLevel = (index, change)=>{
    ...
    const deleteLevel = (index)=>{
        if (confirm("Delete level")) setLevels(levels.filter((l, i)=>i !== index));
    };
    (0, _react.useEffect)(()=>{
            ...
            brickButtons.push(/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("button", {
                onMouseDown: ()=>{
                    if (!applying) {
                        ...
                        setApplying(color);
                        updateLevel(editingIndex, (0, _levelsEditorUtil.setBrick)(level, index, color));
                    }
                },
                onMouseEnter: ()=>{
                    if (applying) updateLevel(editingIndex, (0, _levelsEditorUtil.setBrick)(level, index, applying));
                },
                style: {
                ...
                children: palette[bricks[index]] == "black" && "\uD83D\uDCA3" || " "
            }, index, false, {
        ...
        return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)((0, _jsxDevRuntime.Fragment), {
            children: [
                /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("input", {
                    ...
                    type: "text",
                    value: name,
                    onChange: (e)=>updateLevel(editingIndex, {
                            name: e.target.value
                        })
                }, void 0, false, {
                    fileName: "src/level_editor/levels_editor.tsx",
                ...
                /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("button", {
                            onClick: ()=>deleteLevel(editingIndex),
                            children: "Delete"
                        }, void 0, false, {
                            fileName: "src/level_editor/levels_editor.tsx",
                            lineNumber: 150,
                        ...
                        /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("button", {
                            onClick: ()=>updateLevel(editingIndex, (0, _levelsEditorUtil.resizeLevel)(level, -1)),
                            children: "-"
                        }, void 0, false, {
                            fileName: "src/level_editor/levels_editor.tsx",
                            lineNumber: 151,
                        ...
                        /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("button", {
                            onClick: ()=>updateLevel(editingIndex, (0, _levelsEditorUtil.moveLevel)(level, -1, 0)),
                            children: "L"
                        }, void 0, false, {
                            fileName: "src/level_editor/levels_editor.tsx",
                            lineNumber: 161,
                        ...
                        /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("button", {
                            onClick: ()=>updateLevel(editingIndex, (0, _levelsEditorUtil.moveLevel)(level, 0, -1)),
                            children: "U"
                        }, void 0, false, {
                            fileName: "src/level_editor/levels_editor.tsx",
                            lineNumber: 171,
                ...
                /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                    ...
                    children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                        ...
                        style: {
                            width: size * 40,
                            height: size * 40,
                            background: (0, _pureFunctions.automaticBackgroundColor)(bricks.split(""))
                        },
    ...
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        ...
        children: [
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                id: "list",
                children: levels.map((level, li)=>/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("button", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("button", {
                        ...
                        onClick: ()=>{
                            ...
                            if (!code) return;
                            const l = (0, _levelCodeToRawLevel.levelCodeToRawLevel)(code);
                            if (!l) return;
                            setLevels((list)=>[
                                    ...list.filter((e)=>e.name !== l.name),
                                    l
                                ]);
                            setEditingIndex(levels.length);
                        },
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("datalist", {
                ...
                children: [
                    ...new Set(levels.filter((l, li)=>li !== editingIndex).map((l)=>l.category))
                ].filter(Boolean).map((o)=>/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("option", {
                        value: o
                    }, o, false, {
                        fileName: "src/level_editor/levels_editor.tsx",
                        lineNumber: 284,
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("datalist", {
                id: "existing-authors",
                children: [
                    ...new Set(levels.filter((l, li)=>li !== editingIndex).map((l)=>l.author))
                ].filter(Boolean).map((o)=>/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("option", {
                        value: o
                    }, o, false, {
                        fileName: "src/level_editor/levels_editor.tsx",
...
},{"react/jsx-dev-runtime":"iTorj","../data/palette.json":"ktRBU","react-dom/client":"lOjBx","react":"21dqq","./levels_editor_util":"lfafp","../pure_functions":"6pQh7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../level_code_to_raw_level":"iiELA"}],"iTorj":[function(require,module,exports,__globalThis) {
'use strict';
...
parcelHelpers.export(exports, "brickAt", ()=>brickAt);
parcelHelpers.export(exports, "moveLevel", ()=>moveLevel);
parcelHelpers.export(exports, "setBrick", ()=>setBrick);
function resizeLevel(level, sizeDelta) {
